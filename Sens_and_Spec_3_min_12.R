...
Threshold_3y <- c(0.52, 0.71, 0.77, 0.89, 1.07, 2.92)
...
write.csv(risk_12_at_3y_thresh, file = "risk_12_at_3y_3_min_thresh.csv")
...
Threshold_5y <- c(0.88, 1.15, 1.24, 1.52, 1.74, 4.74)
...
write.csv(risk_12_at_5y_thresh, file = "risk_12_at_5y_3_min_thresh.csv")
